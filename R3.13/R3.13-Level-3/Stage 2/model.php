...
abstract class Product {
        ...
        public function render()
        {
                ...
                $search = ["{{title}}", "{{description}}", "{{price}}", "{{image}}"];
                $replace = [$this->getName(),  $this->getDescription(), $this->getPrice(), $this->getImage()];
