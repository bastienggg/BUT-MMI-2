...
$archer->setDescription("Cette flèche archéonique vous emmènera loin ! Découvrez vite les avantages de cet amiibo compatible avec de multiples jeux");
$archer->setPrice(58.25);
$archer->setImage("./asset/amiibo-link-archer_2x.png");

$zelda = new Amiibo("Zelda", "Switch, Wii U, Nintendo DS");
$zelda->setDescription("Ne sous-estimez pas la princesse Zelda ! Découvrez vite les avantages de cet amiibo compatible avec de multiples jeux");
...
$triforce->setDescription("Un T-shirt à l'effigie de la Triforce, symbole de la sagesse, du courage et de la puissance.");
$triforce->setPrice(20.00);
...
$data = [$archer, $zelda, $rider, $triforce, $hyrule, $sheika];
